...
def test_add_pets_with_valid_data(name='Том', animal_type='cat', age='3', pet_photo='images/кот.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Мурзик', 'cat', '5', 'images/кот.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pets_with_valid_data_without_photo(name='Фося', animal_type='кот', age='6'):
...
def test_successful_update_self_pet_info(name='Ася', animal_type='Кошка', age=3):
...
def test_add_pet_negative_age_number(name='Вася', animal_type='cat', age='3', pet_photo='images/кот.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Tom', animal_type='cat', age='1234', pet_photo='images/кот.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='cat', age='2', pet_photo='images/кот.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='2', pet_photo='images/кот.jpg'):
    ...
    name = 'Барнаби Мармадюк Алоизий Бенджи Кобвеб Дартаньян Эгберт Феликс Гаспар Гумберт Игнатий'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Том', age='3', pet_photo='images/кот.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Том', animal_type='36584', age='3',
                                                      pet_photo='images/кот.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Том', age='2', pet_photo='images/кот.jpg'):
    ...
    animal_type = 'Пепин Кьюллиам Розенкранц Секстон Тедди Апвуд Виватма Уэйленд Ксилон Ярдли Закари Усански'
